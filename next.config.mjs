...
const nextConfig = {
  experimental: {
    // Runs instrumentation.ts on server boot (Next 14) — needed to start the
    // self-hosted Workflow Postgres world in Docker/Azure.
    ...
    outputFileTracingIncludes: {
      '/api/v1/videos/[id]/transcribe': ['./node_modules/ffmpeg-static/**/*'],
